        ...
        <div id='portfolio' className='flex w-full py-20'>
            <div className='container mx-auto'>
                        ...
                        <div key={index} className='flex flex-col md:flex-row gap-4 items-center justify-center mb-10 shadow-xl p-5 rounded-md dark:bg-slate-900'>
                            ...
                            <div className='w-full md:w-1/2'>
                                ...
                                <div className='flex gap-4 mt-4'>
                                    <a href={port.link} target='_blank' rel='noreferrer' className='bg-teal-500 text-white px-4 py-2 rounded-md hover:bg-teal-600 transition-all duration-300 flex flex-row'>
                                        <FaEye className='mt-1 mr-2' /> Demo
                                    </a>
                                    {/* Uncomment this if you have source links */}
                ...
                <div className='text-center mt-20'>
                    <Link href='/portfolio' className={`link ${pathname === '/portfolio' || activeLink === 'portfolio' ? 'active' : ''} bg-teal-500 text-white px-6 py-3 rounded-md hover:bg-teal-600 transition-all duration-300`}>
                        View All Projects
                    </Link>
                </div>
